...
// arif += num;
// }
// return arif; // возвращаем сумму (arif)
// }

// Console.WriteLine("Введите число ");
// int dano= Convert.ToInt32(Console.ReadLine());
// int sum = Arifm(dano); // назначаем переменную и используем с помощью нее метод
// Console.WriteLine("Изначальное число: " + dano + "; Сумма: " + sum);
