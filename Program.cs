...
// {
// int arif= 0;
// for (int count = 0; dano> 0; count++) // пока значение больше 0, цикл работает
// {
// int num = dano % 10; // остаток от деления (453 % 10 = 45,3 = 3)
// dano = dano / 10;
// arif += num;
// count++;
// }
...
// Arifm(arif);
// Console.WriteLine("Сумма: " + arif);

// через организацию метода у меня не получилось, многократно ругается
// через обычную логику работает нормально, как сделать так, чтобы метод заработал? не пойму
...
// Console.WriteLine("ваши числа: " + dano + "их сумма: " + arif);

// как мне сделать чтобы он мне снова говорил, какое у меня число, которое я ввел в начале??
// ибо когда я создаю новую переменную, присваиваю ей наше дано и больше дано не использую, программа вообще виснет..(( 

// Задача 29: Напишите программу, которая задаёт массив из 8 элементов и выводит их на экран.
// 1, 2, 5, 7, 19 -> [1, 2, 5, 7, 19]
// 6, 1, 33 -> [6, 1, 33]

// void FillRandMass(int[] array) // void не дает обратной связи
// {
...
// int[] array = new int [8]; // создали массив на 8 элементов [00000000]
// FillRandMass(array); // заполнили массив array с помощью метода выше
// Console.Write("Ваш случайный массив: ");
// Console.WriteLine(string.Join(", ", array)); // позволит привести string.Join массив в красивый вид, а "," - разделитель